...
public class BigMacAgain{
    ...
    public static void main(String[] args){
        ...
        //initializing various variables for future use
        int num_bigmacs; 
        int pretotal_dollars;
        int pretotal_dimes;
        int pretotal_pennies;
        double total;
        ...
        if (scanner.hasNextInt()){ //checking if the user is about to enter an integer
            ...
            total = num_bigmacs*cost_bigmac; // calculating the total
        }
        ...
        if (num_bigmacs >= 0){ //the number has to be greater than or equal to zero
            ...
            pretotal_dollars = (int)(total); //pretotal dollar value
            pretotal_dimes = (int)(total*10)%10; //pretotal dime value
            pretotal_pennies = (int)(total*100)%10; //pretotal penny value
            System.out.println("In case you forgot, you ordered " +num_bigmacs+ " for $" +pretotal_dollars+ "." +pretotal_dimes+pretotal_pennies+ ".");
